...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 27 nov. 2024 à 14:04
...
INSERT INTO `administrateur` (`id_administrateur`, `ad_mail_admin`, `mdp_admin`, `in_progress`) VALUES
(1, 'admin@gmail.com', '$2y$10$c899C2sLdxbAiDAZlT9lqePt9iGq0MjAQi43rn.YBRA9vOP4zLCgi', 'no'),
(3, 'bdmin@gmail.com', '$2y$10$Z2.WB8BWGTvQpycWFY/Pr.5b7l7UOJcRQRGVvkvlNsrbiQ6KPOifS', 'no');
...
CREATE TABLE `carte` (
  ...
  `modified` varchar(3) NOT NULL DEFAULT 'no',
...
INSERT INTO `carte` (`id_carte`, `texte_carte`, `valeurs_choix1`, `valeurs_choix2`, `date_soumission`, `ordre_soumission`, `id_createur`, `id_administrateur`, `id_deck`, `modified`, `modified_date`) VALUES
(33, 'Le royaume est en proie à la famine. Investir dans l\'agriculture ? Ou augmenter les impôts pour remplir les caisses ?', '10/-5', '-5/15', '2024-10-26', 1, NULL, 1, 5, 'no', '0000-00-00'),
(34, 'Un voisin propose une alliance. Accepterais-tu d\'ignorer son armée ? Ou refuserais-tu pour garder ton indépendance ?', '15/-10', '-5/20', '2024-10-26', 2, 20, NULL, 5, 'no', '0000-00-00'),
(35, 'première carte\r\n555555555555555555555555555555555555555555555555555555555555', '12/24', '1/2', '2024-11-18', 1, NULL, 1, 6, 'no', '0000-00-00'),
(36, 'ezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrhezzfzeferhtrh', '4/-3', '2/-4', '2024-11-18', 2, 21, NULL, 6, 'no', '0000-00-00');
...
INSERT INTO `createur` (`id_createur`, `nom_createur`, `ad_mail_createur`, `mdp_createur`, `genre`, `ddn`, `nb_jaime`) VALUES
(20, 'Camille', 'c@gmail.com', '$2y$10$LJNnUDApO8jB.UscqAUuFuHX14H9opQBwbpu/99H3RiVaI36NOGfO', 'F', '2000-07-13', 1),
(21, 'lapin', 'lapin@gmail.com', '$2y$10$YLiFMYqt/5FAkBceKhUdAuJzaD71RFW/TYT8Qn5Ac15rrdsUxG4oy', 'M', '2024-11-03', 1);
...
CREATE TABLE `deck` (
  ...
  `id_administrateur` int(11) DEFAULT NULL,
  `valid` varchar(3) NOT NULL DEFAULT 'no'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `deck` (`id_deck`, `titre_deck`, `body_deck`, `date_debut_deck`, `date_fin_deck`, `nb_cartes`, `nb_jaime`, `id_administrateur`, `valid`) VALUES
(5, 'Moyen Age', 'Ce deck est à propos du moyen Âge', '2024-10-26', '2024-10-30', 3, 1, 1, 'yes'),
(6, 'Trello', 'Ce deck est à propos de Trello.', '2024-11-18', '2024-12-27', 5, 0, 1, 'no'),
(9, 'FromApi', 'J\'ai fait ce deck grâce à l\'api', '2024-11-20', '2024-12-30', 5, 0, 1, 'yes');
